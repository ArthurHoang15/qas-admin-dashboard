...
const priorityConfig: Record<number, { label: string; className: string }> = {
  ...
  3: {
    label: "P3",
    className: "bg-yellow-200 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400",
  },
  4: {
    label: "P4",
  ...
  5: {
    label: "P5",
    className: "bg-gray-200 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400",
  },
};
...
export function PriorityBadge({ priority }: PriorityBadgeProps) {
  ...
  const config = priorityConfig[priority] || {
    label: `P${priority}`,
    className: "bg-gray-200 text-gray-800 dark:bg-gray-800 dark:text-gray-400",
  };
